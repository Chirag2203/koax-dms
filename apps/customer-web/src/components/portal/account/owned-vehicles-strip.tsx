  ...
  return (
    <div className="flex gap-4 md:gap-6 py-6 first:pt-0 group">
      ...
      <Link
        ...
        className="flex-shrink-0 relative w-[100px] h-[100px] md:w-[120px] md:h-[120px] overflow-hidden bg-bg-subtle"
        tabIndex={-1}
        aria-hidden="true"
      >
        {vehicle.imageUrl ? (
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex items-start justify-between gap-2 mb-1">
          <Link href={`/vehicles/${vehicle.vin}`} className="group/link">
            <h3 className="font-display text-xl text-ink-primary leading-snug group-hover/link:underline underline-offset-4">
        ...
        <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
          ...
          <Link
            ...
            className="flex items-center gap-1.5 font-mono text-[10px] uppercase tracking-widest text-ink-muted hover:text-ink-primary transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent"
          >
  ...
  return (
    <section className="px-6 md:px-12 lg:px-16 py-12">
      ...
      <div className="flex items-end justify-between mb-8 pb-4 border-b border-ink-primary/10">
        <h2 className="font-display text-2xl md:text-3xl italic text-ink-primary">
