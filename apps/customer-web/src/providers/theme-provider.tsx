...
/**
 * Inline script to be embedded in <head> (before React hydration) to prevent
 * theme flash. Paste the result of this function into a <script> tag in layout.tsx:
 *
 *   <script dangerouslySetInnerHTML={{ __html: getThemeScript() }} />
 *
 * It reads the cookie first (SSR-safe), falls back to localStorage, then system pref.
 */
