...
import { consignmentAgreements } from '@dms/mocks/fixtures';
import { AgreementCard } from '@/src/components/consignor/documents';

export default function ConsignorDocumentsPage() {
      ...
      <section className="px-6 md:px-12 lg:px-16 py-8 pb-16">
        {consignmentAgreements.length === 0 ? (
          ...
          <div className="space-y-6">
            {consignmentAgreements.map((agreement) => (
