...
const MESSAGES = {
  ...
  success: 'Diagnostic notes saved',
} as const;

// ─── Types ────────────────────────────────────────────────────────────────────

export interface EditDiagnosisDialogProps {
  open: boolean;
  onClose: () => void;
  jobCardId: string;
  initialValue: string;
...
export function EditDiagnosisDialog({
  open,
  onClose,
  jobCardId,
  initialValue,
  ...
  function handleSubmit() {
    ...
    updateJobCard(jobCardId, { diagnosticNotes: value.trim() }, actor);
